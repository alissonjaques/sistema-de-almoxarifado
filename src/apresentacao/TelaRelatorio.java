...
public class TelaRelatorio extends javax.swing.JFrame {
     ...
     */
    public TelaRelatorio(ArrayList<String> corredor, ArrayList<String> receptaculo, ArrayList<String> codigoProduto, ArrayList<String> codigoUPC) {
    ...
    public void preencherRelatorio() {
        DefaultTableModel model = (DefaultTableModel) getTabelaRelatorio().getModel();
        int i = 0;
    ...
    private void initComponents() {
        ...
        setTitle("Relatório de Distribuição de Peças");
        ...
        if (tabelaRelatorio.getColumnModel().getColumnCount() > 0) {
            ...
            tabelaRelatorio.getColumnModel().getColumn(0).setPreferredWidth(20);
            tabelaRelatorio.getColumnModel().getColumn(1).setMinWidth(30);
            tabelaRelatorio.getColumnModel().getColumn(1).setPreferredWidth(30);
        }
