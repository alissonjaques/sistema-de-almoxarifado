...
public class TelaDeLogin extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lTitulo.setText("Login Almoxarifado");
            ...
            .addGroup(pLoginLayout.createSequentialGroup()
                ...
                .addGroup(pLoginLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pLoginLayout.createSequentialGroup()
                        ...
                        .addGap(5, 5, 5))
                    .addComponent(tfUsuario, javax.swing.GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        if(usuario.equals(getUsuarioFix()) && senha.equals(getSenhaFix())){
            getTp().getJmCadastro().setEnabled(true);
            getTp().getJmOrdens().setEnabled(true);
            getTp().getJmPedido().setEnabled(true);
     ...
     */
    public void setTp(TelaInicial tp) {
        this.tp = tp;
    }
